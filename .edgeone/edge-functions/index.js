      ...
      function usercode(ev, hookCtx) {
        ...
        const runEdgeFunctions = () => {
            ...
            if(!matchedFunc && '/api/status' === urlInfo.pathname && request.method === 'GET') {
              matchedFunc = true;
                (() => {
    ...
    return new Response(JSON.stringify(body), {
      headers: { "Content-Type": "application/json" }
        ...
        const middlewareResponse = await runMiddleware({
          ...
          env: {"ProjectId":"makers-zufksp0hxlxv","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/02/w62phj0j52l9mqf0xsnq51gh0000gn/T/","EDGEONE_PROJECT_ID":"makers-zufksp0hxlxv","PAGES_PROJECT_ID":"makers-zufksp0hxlxv"},
          waitUntil,
          hookCtx
        });
        ...
        if (middlewareResponse) {
          ...
          const edgeFunctionResponse = await pagesFunctionResponse({request, params, env: {"ProjectId":"makers-zufksp0hxlxv","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/02/w62phj0j52l9mqf0xsnq51gh0000gn/T/","EDGEONE_PROJECT_ID":"makers-zufksp0hxlxv","PAGES_PROJECT_ID":"makers-zufksp0hxlxv"}, waitUntil, eo });
        ...
        })({request: ev.request, params: {}, env: {"ProjectId":"makers-zufksp0hxlxv","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/02/w62phj0j52l9mqf0xsnq51gh0000gn/T/","EDGEONE_PROJECT_ID":"makers-zufksp0hxlxv","PAGES_PROJECT_ID":"makers-zufksp0hxlxv"}, waitUntil: ev.waitUntil.bind(ev) });
        // ↑ 用户原始代码结束
      }
